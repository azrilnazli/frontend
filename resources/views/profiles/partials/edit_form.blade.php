    ...
    <div class="col-md">
        ...
        <div class="input-group">
            ...
            <div class="custom-file">
                ...
                <label class=" bg-dark text-white custom-file-label" for="inputGroupFile01">Choose file</label>
            </div>
        </div>
...
<div class="form-group row">
    ...
    <div class="col-md">
        <textarea name="address" id="" cols="30" rows="10" class=" bg-dark text-white form-control  @error('address') is-invalid @enderror">{{ $profile->address }}</textarea>
